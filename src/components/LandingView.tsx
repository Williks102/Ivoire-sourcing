                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {[
                          ...
                          <button
                            ...
                            className={`py-3 px-2 rounded-xl text-[11px] font-black border uppercase tracking-wider transition-all text-center flex flex-col items-center gap-1 ${paymentOperator === op.id ? 'bg-slate-900 border-slate-900 text-white' : 'bg-slate-50 hover:bg-slate-100 border-slate-200 text-slate-600'}`}
                          >
                            {op.label}
                          </button>
                        ))}
